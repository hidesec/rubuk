      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mb-12 space-y-4">
          ...
          <p className="text-warm-gray leading-relaxed">
            Jelajahi daftar buku yang menjadi bahan diskusi dan rekomendasi dari komunitas RUBUK.
          </p>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                activeGenre === genre
                  ...
                  : "bg-cream border border-cream-dark/40 text-warm-gray hover:border-cream-dark hover:text-espresso"
              }`}
            >
              {genre}
            </button>
        ...
        {filteredBooks.length === 0 && (
          <div className="text-center py-20">
            <p className="text-warm-gray">Tidak ada buku dalam genre ini.</p>
          </div>
        )}
      </div>
    </section>
